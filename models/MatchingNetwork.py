...
import torch, tqdm, sys, importlib
import torch.nn as nn
import unittest
import numpy as np
from models.BidirectionalLSTM import BidirectionalLSTM
from models.Classifier import Classifier, CustomClassifier
...
class MatchingNetwork(nn.Module):
    def __init__(self, keep_prob, encoder_features, \
        ...
        # self.g = CustomClassifier(encoder_features=encoder_features, layer_size = 64, num_channels=num_channels,
        #                     nClasses= nClasses, image_size = image_size )
    ...
    def forward(self, support_set_images, support_set_labels_one_hot, target_image, target_label, get_output_embeddings=False):
        ...
        :return: 
        """
        # print("SHAPES: \n-support_set_images", support_set_images.size())
        # print("-support_set_labels_one_hot", support_set_labels_one_hot.size())
        # print("-target_image", target_image.size())
        # print("-target_label", target_label.size())
        ...
        # return accuracy, crossentropy_loss, indices.squeeze(), similarities
        return accuracy, crossentropy_loss, None, None
